...
if(!isset($_GET['id']) || (isset($_GET['id']) && $_GET['id'] == "")) {
	...
	echo "<meta http-equiv='refresh' content='0;url=../view_students'>"; exit();
	
}

$sql_student = "SELECT * FROM students WHERE studentID = '$_GET[id]'";
...
$sql_student_subjects = "SELECT * FROM student_subjects WHERE student_no = '$row_student[student_no]'";
...
if($num_student_subjects > 0) {
    ...
    do {
        ...
        array_push($subject_no, $row_student_subjects['subject_no']);

    } while($row_student_subjects = mysqli_fetch_assoc($result_student_subjects));
...
<html lang="en">
  ...
  <head>
    <title>Edit Student [ <?php echo $row_student['first_name']; ?> ] - Students: Management System | Brave</title>
  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Edit Student</h4>
        <p class="mg-b-0">Edit <?php echo $_GET['id'] . ' - '. $row_student['first_name']; ?></p>
      </div>
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <form name="form_action" id="form_action" action="../process/" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" id="student_no" name="student_no" value="<?php echo $row_student['student_no']; ?>">
            <input type="hidden" id="studentID" name="studentID" value="<?php echo $_GET['id']; ?>">
            <input type="hidden" id="photo2" name="photo2" value="<?php echo $row_student['photo']; ?>">
            ...
            <div class="form-layout form-layout-6">
              ...
              <div class="row no-gutters">
                  ...
                  <div class="col-2 col-sm-1">
                    <div id="preview">
                        <?php if($row_student['photo'] != NULL || $row_student['photo'] != "") { ?>
                            <img src="<?php echo $server; ?>/img/students/<?php echo $row_student['photo']; ?>" style="height:50px">
                        <?php } else { ?>
                ...
                <div class="row no-gutters">
                  ...
                  <div class="col-7 col-sm-9">
	                  <input class="form-control" type="text" id="first_name" name="first_name" maxlength="18" value="<?php echo $row_student['first_name']; ?>" required>
                  </div><!-- col-8 -->
                </div><!-- row -->
                ...
                <div class="row no-gutters">
                  ...
                  <div class="col-7 col-sm-9">
	                  <input class="form-control" type="text" id="last_name" name="last_name" maxlength="18" value="<?php echo $row_student['last_name']; ?>" required>
                  </div><!-- col-8 -->
                </div><!-- row -->
                ...
                <div class="row no-gutters">
                  ...
                  <div class="col-7 col-sm-9">
                    <input class="form-control" type="text" id="birth_date" name="birth_date" placeholder="MM/DD/YYYY" value="<?php echo date("m/d/Y",strtotime($row_student['birth_date']));; ?>" required>
                  </div><!-- col-8 -->
                </div><!-- row -->
                ...
                <div class="row no-gutters">
                  ...
                  <div class="col-7 col-sm-9">
                    <textarea class="form-control" type="text" id="address" name="address" required><?php echo $row_student['address']; ?></textarea>
                  </div><!-- col-8 -->
                </div><!-- row -->
                ...
                <div class="row no-gutters">
                  ...
                  <div class="col-7 col-sm-9">
	                  <input class="form-control" type="text" id="full_name" name="full_name" maxlength="38" value="<?php echo $row_student['full_name']; ?>" required>
                  </div><!-- col-8 -->
                </div><!-- row -->
                ...
                <div class="row no-gutters">
                  ...
                  <div class="col-7 col-sm-9">
                    <input class="form-control" type="text" id="contact_phone" name="contact_phone" maxlength="14" value="<?php echo $row_student['contact_phone']; ?>" required>
                  </div><!-- col-8 -->
                </div><!-- row -->
                ...
                <div class="row no-gutters">
                  ...
                  <div class="col-7 col-sm-9">
                    <select id="class_no" class="form-control select2-show-search" name="class_no" required>
                        ...
                        <?php do { ?>
                            <option value="<?php echo $row_classes['class_no']; ?>" <?php if($row_classes['class_no'] == $row_student['class_no']) { echo 'selected'; } ?>><?php echo $row_classes['class_name']; ?></option>
                ...
                <div class="row no-gutters">
                  ...
                  <div class="col-7 col-sm-9">
                    <select id="subject_no" class="form-control select2-show-search" multiple name="subject_no[]" required>
                        <?php do { ?>
                            <option value="<?php echo $row_subjects['subject_no']; ?>" <?php if(in_array($row_subjects['subject_no'], $subject_no)) { echo 'selected'; } ?>><?php echo $row_subjects['title']; ?></option>
                ...
                <div class="row no-gutters">
                  ...
                  <div class="form-layout-footer col-7 col-sm-9 bd pd-20 bd-t-0">
                    <input class="btn btn-primary" id="submit" type="submit" style="cursor:pointer" value="Edit Student"> 
                  </div><!-- col-8 -->
                </div><!-- row -->
          ...
          <pre><code class="javascript pd-20">This will update the student details in the system. All fields with <span class="tx-danger">*</span> are mandatory</code></pre>
